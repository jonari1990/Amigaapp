...
<html lang="en">
  ...
  <link rel="icon" href="favicon.ico">
    ...
    <title>Amigaapp - @yield('title') </title>
  ...
  <meta name="description" content="Wizard examples" />
    ...
    <link href="vendor/assets/css/pages/wizard/wizard-1.css" rel="stylesheet" type="text/css" />
    <link href="vendor/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
  ...
  <body id="kt_body" class="header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile">
      <!--begin::Logo-->
      <a href="index.html">
        <img alt="Logo" src="vendor/assets/media/logos/logo-2.svg" class="max-h-30px" />
      </a>
      <!--end::Logo-->
      <!--begin::Toolbar-->
    ...
    <div class="aside aside-left aside-fixed" id="kt_aside">
      ...
      <div class="aside-brand h-80px px-7 flex-shrink-0">
        ...
        <a href="index.html" class="aside-logo">
          <img alt="Logo" src="vendor/assets/media/logos/logo-2.svg" class="max-h-40px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
            ...
            <div class="container">
              ...
              <div class="topbar">
                ...
                <div class="topbar-item mr-2">
                  <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle" id="kt_quick_search_toggle">
                ...
                <!--begin::Quick Actions-->
                <div class="topbar-item mr-2">
                  <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle btn-dropdown" id="kt_quick_actions_toggle">
                    <span class="svg-icon svg-icon-lg">
                      <!--begin::Svg Icon | path:assets/media/svg/icons/Media/Equalizer.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <!--begin::Quick panel-->
                <div class="topbar-item mr-2">
                  <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle" id="kt_quick_panel_toggle">
                    <span class="svg-icon svg-icon-lg">
                      <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <!--begin::Chat-->
                <div class="topbar-item mr-2">
                  <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle" data-toggle="modal" data-target="#kt_chat_modal">
                    <span class="svg-icon svg-icon-lg">
                ...
                <div class="dropdown mr-2">
                  ...
                  <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle btn-dropdown">
                      <img class="h-20px w-20px rounded-circle" src="vendor/assets/media/svg/flags/226-united-states.svg" alt="" />
                    </div>
                  </div>
                  <!--end::Toggle-->
                  <!--begin::Dropdown-->
                  <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                      ...
                      <li class="navi-item">
                        <a href="#" class="navi-link">
                          <span class="symbol symbol-20 mr-3">
                            <img src="vendor/assets/media/svg/flags/226-united-states.svg" alt="" />
                          </span>
                      ...
                      <li class="navi-item active">
                        <a href="#" class="navi-link">
                          <span class="symbol symbol-20 mr-3">
                            <img src="vendor/assets/media/svg/flags/128-spain.svg" alt="" />
                          </span>
                      ...
                      <li class="navi-item">
                        <a href="#" class="navi-link">
                          <span class="symbol symbol-20 mr-3">
                            <img src="vendor/assets/media/svg/flags/162-germany.svg" alt="" />
                          </span>
                      ...
                      <li class="navi-item">
                        <a href="#" class="navi-link">
                          <span class="symbol symbol-20 mr-3">
                            <img src="vendor/assets/media/svg/flags/063-japan.svg" alt="" />
                          </span>
                      ...
                      <li class="navi-item">
                        <a href="#" class="navi-link">
                          <span class="symbol symbol-20 mr-3">
                            <img src="vendor/assets/media/svg/flags/195-france.svg" alt="" />
                          </span>
                ...
                <div class="topbar-item mr-3">
                  <div class="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle align-items-center overflow-hidden" id="kt_quick_user_toggle">
                    <img alt="Logo" src="vendor/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" />
                  </div>
                </div>
                <!--end::User-->
              </div>
   ...
   <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
            ...
            <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
              ...
              <div class="text-dark order-2 order-md-1">
                ...
                <a href="https://www.amigaapp.com/" target="_blank" class="text-dark-75 text-hover-primary">Amigaapp.com</a>
              </div>
              <!--end::Copyright-->
              <!--begin::Nav-->
              <div class="nav nav-dark order-1 order-md-2 font-weight-bold">
                <a href="https://www.amigaapp.com/" target="_blank" class="nav-link pr-3 pl-0">About</a>
                <a href="https://www.amigaapp.com/" target="_blank" class="nav-link px-3">Team</a>
                <a href="https://www.amigaapp.com/" target="_blank" class="nav-link pl-3 pr-0">Contact</a>
              </div>
              <!--end::Nav-->
            </div>
            <!--end::Container-->
              ...
              <div class="mb-10">
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                    <img src="vendor/assets/media/svg/files/doc.svg" alt="" />
                  </div>
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                    <img src="vendor/assets/media/svg/files/pdf.svg" alt="" />
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                    <img src="vendor/assets/media/svg/files/xml.svg" alt="" />
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                    <img src="vendor/assets/media/svg/files/csv.svg" alt="" />
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
              ...
              <div class="mb-10">
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 flex-shrink-0">
                    <div class="symbol-label" style="background-image:url('vendor/assets/media/users/150-2.jpg')"></div>
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 flex-shrink-0">
                    <div class="symbol-label" style="background-image:url('vendor/assets/media/users/150-14.jpg')"></div>
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
                ...
                <div class="d-flex align-items-center flex-grow-1 mb-2">
                  <div class="symbol symbol-30 flex-shrink-0">
                    <div class="symbol-label" style="background-image:url('vendor/assets/media/users/150-11.jpg')"></div>
                  </div>
                  <div class="d-flex flex-column ml-3 mt-2 mb-2">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
      ...
      <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">User Profile: Amiga</h3>
      ...
      <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
          <div class="symbol symbol-100 mr-5">
            <div class="symbol-label" style="background-image:url('vendor/assets/media/users/150-6.jpg')"></div>
            <i class="symbol-badge bg-success"></i>
          </div>         
          <div class="d-flex flex-column">
            @if(isset(Auth::user()->email))
            <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ $user->profile1(auth()->user()->id)->name.' '.$user->profile1(auth()->user()->id)->lastname }}</a>
            @else
            <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">Ryan Smith</a>
            @endif
            
            @if(isset($user->profile1(auth()->user()->id)->birthdate))
              <div class="text-muted mt-1">age: {{ $user->calculaedad($user->profile1(auth()->user()->id)->birthdate) }} Years</div>
            @else
            <div class="text-muted mt-1">age: -- Years</div>
            @endif
            <div class="navi mt-1">
        ...
        <div class="navi navi-spacer-x-0 p-0">
          ...
          <span class="navi-item mt-2">
            <span class="navi-link">
              <a class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6" href="{{ route('logout') }}" data-toggle="modal" data-target="#logoutModal">Sign Out</a>
            </span>
          </span>
          <!--end:Item-->
        </div>
            ...
            <div class="mb-5">
              ...
              <div class="d-flex align-items-center mb-6">
                ...
                <div class="symbol symbol-35 flex-shrink-0 mr-3">
                  <img alt="Pic" src="vendor/assets/media/users/150-5.jpg" />
                </div>
                <!--end::Symbol-->
                <!--begin::Content-->
              ...
              <div class="d-flex align-items-center mb-6">
                <!--begin::Symbol-->
                <div class="symbol symbol-35 flex-shrink-0 mr-3">
                  <img alt="Pic" src="vendor/assets/media/users/150-7.jpg" />
                </div>
                <!--end::Symbol-->
                <!--begin::Content-->
                <div class="d-flex flex-wrap flex-row-fluid">
              ...
              <div class="scroll scroll-pull" data-height="375" data-mobile-height="300">
                ...
                <div class="messages">
                  ...
                  <div class="d-flex flex-column mb-5 align-items-end">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-circle symbol-40 ml-3">
                        <img alt="Pic" src="vendor/assets/media/users/150-9.jpg" />
                      </div>
                    </div>
                  ...
                  <div class="d-flex flex-column mb-5 align-items-start">
                    <div class="d-flex align-items-center">
                      <div class="symbol symbol-circle symbol-40 mr-3">
                        <img alt="Pic" src="vendor/assets/media/users/150-2.jpg" />
                      </div>
                      <div>
                        <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</a>
                        <span class="text-muted font-size-sm">40 seconds</span>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo1.png" alt="" class="w-100" />
            </div>
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo2.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo3.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo4.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo5.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo6.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo7.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo8.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
          ...
          <div class="overlay rounded-lg mb-8 offcanvas-demo">
            <div class="overlay-wrapper rounded-lg">
              <img src="vendor/assets/media/demos/demo9.png" alt="" class="w-100" />
            </div>
            <div class="overlay-layer">
              <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
            </div>
  ...
  <script src="{{ asset('jquery-easing/jquery.easing.min.j') }}"></script>
  ...
  <!--end::Global Config-->
    ...
    <script src="vendor/assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <script src="vendor/assets/js/pages/custom/wizard/wizard-1.js"></script>

    <script src="vendor/assets/js/pages/features/file-upload/image-input.js"></script>
    <script src="vendor/assets/js/pages/features/ktdatatable/advanced/column-rendering.js"></script>
    <script src="vendor/assets/js/pages/features/datatables/advanced/column-rendering.js"></script>
