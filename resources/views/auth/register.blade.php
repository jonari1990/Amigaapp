...
<div class="d-flex flex-column flex-root">
          ...
          @endif
                    <form class="form" method="POST" action="{{ url('saveamiga') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" type="text" placeholder="Name" name="name" value="{{ old('name') }}" required />
                                </div>

                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" type="text" placeholder="Lastname" name="lastname" value="{{ old('lastname') }}" required/>
                                </div>
                                <!--end::Form group-->
                                <!--begin::Form group-->
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" type="email" placeholder="Email" name="email" value="{{ old('email') }}" required/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" type="password" placeholder="Password" name="password" required pattern="[A-Za-z0-9]{5,15}" title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 15" autocomplete="off"  />
                                </div>
