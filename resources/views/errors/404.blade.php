...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="bg-white header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		<!--begin::Main-->
			...
			<div class="d-flex flex-column-fluid flex-center">
				<div class="d-flex flex-center flex-column flex-lg-row p-10 p-lg-20">
					<div class="d-flex flex-column justify-content-center align-items-center align-items-lg-end flex-row-fluid order-2 order-lg-1">
						...
						<a href="{{ url('/') }}" class="btn btn-light-primary font-weight-bolder py-4 px-8">
					...
					<img src="vendor/assets/media/error/bg1.jpg" alt="image" class="w-100 w-sm-350px w-md-600px order-1 order-lg-2" />
				</div>
			</div>
			<!--end::Error-->
		</div>
